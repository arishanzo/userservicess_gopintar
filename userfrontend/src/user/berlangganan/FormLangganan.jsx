...
const FormLangganan = () => {
 ...
 <div className="flex bg-green-10">
    ...
    <div className="flex-1  py-24 p-4 top-0 min-h-screen w-[80%]">
    ...
    {loading ? (
     ...
     <div className="p-8 border border-gray-200 rounded-2xl shadow-sm flex flex-col animate-pulse">
        ...
        <section class="bg-gray-50  px-2 w-full">
     <div className="flex items-center space-x-4 md:pl-8 py-2 md:py-4">
           <button
