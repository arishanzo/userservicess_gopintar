const MobileMenu = () => {
  return (
    <div className="md:hidden fixed bottom-0 left-0 z-50 w-full py-4 bg-white border-t border-gray-200">
      <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
        ...
        <div className="flex items-center justify-center">
          <a href="https://api.whatsapp.com/send/?phone=088805317354&text&type=phone_number&app_absent=0" className="inline-flex items-center justify-center w-10 h-10 font-medium bg-green-600 rounded-full hover:bg-green-700 group">
